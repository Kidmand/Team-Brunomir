...
public class SeventhSceneScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("/emote:Normal/Los días pasaron y no encontraban nada, excepto un artilugio que parecía ser una esfinge. Según arqueólogos, dijeron que la esfinge tenía aproximadamente 2000 años y que era procedente de Egipto.","Dante"));
