...
public class FirstSceneScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var selectionText = new DialogData("Choose an option:", "Li");
        selectionText.SelectList.Add("Option A", "A");
        selectionText.SelectList.Add("Option B", "B");
        selectionText.SelectList.Add("Option C", "C");
    ...
    private void HandleSelection()
    {
        ...
        {
            dialogTexts.Add(new DialogData("You chose option A!", "Li"));
        }
        else if (DialogManager.Result == "B")
        {
            dialogTexts.Add(new DialogData("You chose option B!", "Li"));
        }
        else if (DialogManager.Result == "C")
        {
            dialogTexts.Add(new DialogData("You chose option C!", "Li"));
        }
