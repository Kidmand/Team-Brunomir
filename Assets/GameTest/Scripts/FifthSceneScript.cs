...
public class FifthSceneScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("/size:down//emote:Normal/No soy de por aquí, de hecho hace poco que vine a la ciudad por lo que no conozco mucho. Además, me gusta explorar nuevos lugares y principalmente quería venir a este bosque.", "Dafne"));
        ...
        dialogTexts.Add(new DialogData("/size:down//emote:Normal/Nadie nunca lo supo en realidad, muchas de las personas de por aquí veían al hombre hablar con otros hombres trajeados. Claramente hombres de la alta sociedad.", "Dante"));
