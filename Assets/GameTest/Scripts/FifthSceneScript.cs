...
public class FifthSceneScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("/emote:Normal/ Bueno, lo cierto es que luego de descansar un rato aquí, mi idea era ir al bosque. Ya que te has presentado te pregunto /emote:Happy/¿Te gustaría acompañarme?.", "Dante"));
        dialogTexts.Add(new DialogData("/size:down//emote:Sonrojada/ ¡Sii, me encantaría acompañarte! /wait:0.1//emote:Normal/Creo que será divertido, si bien el tiempo está hermoso, hace un poco de calor a pesar de que estemos en otoño, con lo cual estaría bien ir al bosque que siemrpe suele estar más frío.", "Dafne"));
        ...
        dialogTexts.Add(new DialogData("Presiona space para ir al bosque con Dafne.", "Dante"));
