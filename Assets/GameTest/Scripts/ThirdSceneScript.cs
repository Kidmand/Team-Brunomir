...
public class ThirdSceneScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("/size:down//emote:Sonrojada/ ¡Sii, me encantaría acompañarte! /emote:Normal/Creo que será divertido, si bien el tiempo está hermoso, hace un poco de calor a pesar de que estemos en otoño, con lo cual estaría bien ir al bosque que siemrpe suele estar más frío.", "Dafne"));
